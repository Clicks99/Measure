...
(function (document) {
    var Cookie = (function () {
        function Cookie() {
            ...
            this.random = (Math.random()*1e32).toString(36);
        }
